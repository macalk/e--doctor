...
- (void)createTitleBtnWithBtnArray:(NSArray *)titleBtnArray {
    ...
    //横线
    UILabel *grayLineLabel = [[UILabel alloc]init];
    grayLineLabel.backgroundColor = [UIColor stringTOColor:@"#f4f4f4"];
    grayLineLabel.frame = CGRectMake(0, self.frame.size.height-1, kScreenWidth, 1);
    [self addSubview:grayLineLabel];
    ...
    for (int i = 0; i<titleBtnArray.count; i++) {
        ...
        [button setTitleColor:[UIColor stringTOColor:@"#6f6f6f"] forState:normal];
        [button setTitleColor:[UIColor stringTOColor:@"#22ccc6"] forState:UIControlStateSelected];
    ...
    UILabel *lineLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, self.bounds.size.height-1, _lineWidth, 1)];
    lineLabel.backgroundColor = [UIColor stringTOColor:@"#22ccc6"];
...
- (void)titleButtonClick:(UIButton *)sender {
    ...
    [UIView animateWithDuration:0.25 animations:^{
        ...
        self.lineLabel.frame = CGRectMake(_lineWidth*(sender.tag-100), self.lineLabel.frame.origin.y, _lineWidth, 1);
    }];
