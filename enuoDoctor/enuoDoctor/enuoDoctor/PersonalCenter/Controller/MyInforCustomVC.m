...
@interface MyInforCustomVC ()

@end

@implementation MyInforCustomVC
...
- (void)viewDidLoad {
    ...
    [self createCustomNavViewWithTitle:nil andLeftImage:@"白色返回" withLeftTitle:@"我的消息" andRightImage:nil withRightTitle:nil];
}
